import re
# Global list of known malware
malware_names = ['Shamoon', 'Stuxnet', 'Emotet', 'Ryuk']
...
def add_custom_malware(custom_list):

    # Dynamically add custom malware names to the list.
    
    global malware_names
    malware_names.extend(custom_list)

def remove_custom_malware(malware_list):

   #Dynamically remove malware names from the global list.
